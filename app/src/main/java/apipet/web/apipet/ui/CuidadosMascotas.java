...
import apipet.web.apipet.ui.WebCuidadosMascota;

public class CuidadosMascotas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuidados_mascotas);
        hideNavigationBar();
        ...
        btn_ver_mas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v2) {
                Intent i2 = new Intent(getApplicationContext(),WebCuidadosMascota.class);
                startActivity(i2);
        ...
        String uriPath2 = "android.resource://apipet.web.apipet/"+R.raw.cuidados_mascotas;
        ...
        btnVideo.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                video = (VideoView)findViewById(R.id.videoView);
                String uriPath = "android.resource://apipet.web.apipet/"+R.raw.cuidados_mascotas;
