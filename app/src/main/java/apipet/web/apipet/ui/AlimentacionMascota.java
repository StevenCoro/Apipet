...
import apipet.web.apipet.ui.WebAlimentacionMascota;

public class AlimentacionMascota extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alimentacion_mascota);
        hideNavigationBar();
        ...
        btn_ver_mas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v2) {
                Intent i2 = new Intent(getApplicationContext(),WebAlimentacionMascota.class);
                startActivity(i2);
        ...
        String uriPath2 = "android.resource://apipet.web.apipet/"+R.raw.alimentacion;
        ...
        btnVideo.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                video = (VideoView)findViewById(R.id.videoView);
                String uriPath = "android.resource://apipet.web.apipet/"+R.raw.alimentacion;
